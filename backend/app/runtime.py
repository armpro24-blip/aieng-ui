...
_INTENT_MAP: list[tuple[list[str], str, str]] = [
    ...
    (
        [
            "geometry", "freecad", "几何", "inspect geometry",
            "bounding box", "volume", "face count", "edge count",
            "cad geometry", "shape", "solid", "part geometry",
        ],
        "freecad.inspect_geometry",
        "Inspect CAD geometry via FreeCADCmd: face/edge/vertex counts, bounding box, volume",
    ),
    (
        [
            "export", "step export", "re-export", "export step", "freecad export",
            "update step", "export cad", "export model", "导出", "步骤文件", "导出step",
        ],
        "freecad.export_step",
        "Export CAD geometry to STEP format via FreeCADCmd",
    ),
    (
        ["macro", "脚本", "宏", "run macro"],
        "freecad.run_macro",
